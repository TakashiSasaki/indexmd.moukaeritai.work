...
import { SUMMARY_ANALYSIS_SCHEMA, SUMMARY_ANALYSIS_SCHEMA_VERSION, validateSummaryAnalysisResult } from "./src/lib/summaryAnalysisSchema";
         ...
         try {
           ...
           if (mode === "structured") {
             try {
               ...
               if (validateSummaryAnalysisResult(parsed)) {
                 result.structured = parsed;
                 result.summary = parsed.oneLineSummary || "No summary generated";
               } else {
